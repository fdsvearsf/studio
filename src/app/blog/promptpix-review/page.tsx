    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-4 pb-20">
        <article className="max-w-2xl mx-auto">
          ...
          <h1 className="text-2xl font-bold mb-4">PromptPix Review: What It Is and How It Works</h1>
          ...
          <div className="prose dark:prose-invert max-w-none space-y-3 text-xs text-muted-foreground">
            <h2 className="text-lg font-semibold pt-2 text-foreground">What is PromptPix?</h2>
            <p>
            ...
            <h2 className="text-lg font-semibold pt-2 text-foreground">How Does It Work?</h2>
            <p>
            ...
            <h2 className="text-lg font-semibold pt-2 text-foreground">Who is it For?</h2>
            <p>
            ...
            <h2 className="text-lg font-semibold pt-2 text-foreground">Key Features</h2>
             <ul className="list-disc list-inside space-y-1">
