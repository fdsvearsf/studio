      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <article className="max-w-2xl mx-auto">
          ...
          <div className="prose dark:prose-invert max-w-none space-y-3 text-xs sm:text-base text-muted-foreground">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold pt-2 sm:pt-4 text-foreground">Step 1: Browse the Gallery</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-semibold pt-2 sm:pt-4 text-foreground">Step 2: Select an Image</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-semibold pt-2 sm:pt-4 text-foreground">Step 3: Generate the Prompt</h2>
            <p>
             ...
             <h2 className="text-xl sm:text-2xl font-semibold pt-2 sm:pt-4 text-foreground">Step 4: Copy and Use</h2>
            <p>
