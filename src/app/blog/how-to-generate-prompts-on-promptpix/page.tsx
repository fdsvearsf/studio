    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-4 pb-20">
        <article className="max-w-2xl mx-auto">
          ...
          <h1 className="text-2xl font-bold mb-4">How to Generate AI Image Editing Prompts on PromptPix</h1>
          ...
          <div className="prose dark:prose-invert max-w-none space-y-3 text-xs text-muted-foreground">
            ...
            <h2 className="text-lg font-semibold pt-2 text-foreground">Step 1: Browse the Gallery</h2>
            <p>
            ...
            <h2 className="text-lg font-semibold pt-2 text-foreground">Step 2: Select an Image</h2>
            <p>
            ...
            <h2 className="text-lg font-semibold pt-2 text-foreground">Step 3: Generate the Prompt</h2>
            <p>
             ...
             <h2 className="text-lg font-semibold pt-2 text-foreground">Step 4: Copy and Use</h2>
            <p>
