    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <article className="max-w-2xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">How to Edit Photos Using PromptPix Prompts in ChatGPT, Grok, and Other AI Tools</h1>
          <p className="text-muted-foreground mb-6">Posted on {new Date().toLocaleDateString()}</p>
          
          <div className="relative aspect-video w-full mb-8 rounded-lg overflow-hidden">
             <Image
                src="https://placehold.co/600x400.png"
                alt="Logos of various AI tools like ChatGPT and Grok"
                fill
                className="object-cover"
                data-ai-hint="AI logos"
              />
          </div>
          ...
          <div className="prose dark:prose-invert max-w-none space-y-4 text-muted-foreground">
            ...
            <h2 className="text-2xl font-semibold pt-4 text-foreground">Using Prompts in ChatGPT (with DALL-E 3)</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold pt-4 text-foreground">Using Prompts in Grok, Gemini, and Other Chatbots</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold pt-4 text-foreground">Tips for Best Results</h2>
